...
func (cu *CardUpdate) SetExpiredTime(t time.Time) *CardUpdate {
	cu.mutation.SetExpiredTime(t)
	return cu
}
...
func (cu *CardUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.ExpiredTime(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
...
func (cuo *CardUpdateOne) sqlSave(ctx context.Context) (_node *Card, err error) {
	...
	if value, ok := cuo.mutation.ExpiredTime(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: card.FieldExpiredTime,
